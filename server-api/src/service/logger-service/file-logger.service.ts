...
import configuration from 'src/shared/utils/configuration';
@Injectable()
export class FileLogger implements LoggerService {
  ...
  private readonly logName: string = 'server';
  ...
  constructor() {
    ...
    this.LOGGING_DAYS = Number.parseInt(configValues.LOGGING_DAYS || '7', 10);
