...
// Define the props type for the Switch component
interface SwitchProps extends React.InputHTMLAttributes<HTMLInputElement> {
  ...
  color?:
    ...
    | 'indigo'
    | 'gray'
    | string; // Fallback to string for any other colors
}
...
const Switch: React.FC<SwitchProps> = (props) => {
  ...
  return (
    <input
      ...
      before:absolute before:top-[50%] before:h-4 before:w-4 before:translate-x-[1px] before:translate-y-[-50%] before:rounded-[20px]
      ...
      dark:bg-white/5 dark:border-none ${
        color === 'red'
